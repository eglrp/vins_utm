...
//    if (strcmp(strIP, "www.analysis-api.tm-uas.com")){
//        strIP = "54.169.63.192";
//    }
    if(strIP == NULL) {
    ...
    int inetPton = inet_pton(AF_INET, strIP, &servaddr.sin_addr); // <= 0
    DebugOut("%s %s %d\tinetPton = %d, strIP = %s\n", __FILE__, __FUNCTION__, __LINE__, inetPton, strIP);
    if ( inetPton <= 0 ) {
